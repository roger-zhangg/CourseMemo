// Winch with PID control (vertical)
...
public class Winch5 extends JPanel {
    ...
    void nextStep ()
    {
        ...
        // INSERT YOUR CODE HERE for full PID control,
	// adding the kI*S term to proportional-derivative control
