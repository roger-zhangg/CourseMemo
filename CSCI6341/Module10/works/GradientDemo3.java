...
public class GradientDemo3 extends JPanel {

    double alpha = 0.1;           // Algorithm parameter: the stepsize.
	...
	derivAtCurrentX = computefDeriv (currentX);
        System.out.println ("x=" + currentX + "  a*f'(x)=" + (alpha*derivAtCurrentX));
    ...
    {
        GradientDemo3 gradientDemo = new GradientDemo3 ();
