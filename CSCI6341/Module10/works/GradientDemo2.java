...
// Mar, 2008
//
// An example demonstrating the local vs. global optimization.
...
public class GradientDemo2 extends JPanel {
    ...
    {
	return 6 + Math.pow (x-3,2) - 3*Math.sin (3*x);
    }
    ...
    {
        GradientDemo2 gradientDemo = new GradientDemo2 ();
