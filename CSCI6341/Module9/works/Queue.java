...
public class Queue {
	...
	Customer c = queue.removeFirst ();
        ...
        mt.add(timeInSystem);
    if (mt.getHalfConfidenceInterval()/mt.getMean()<=0.05 && mt.numSamples > 50){
    ...
    double tmp = randomInterarrivalTime();
    mi.add(tmp);
    if (mi.getHalfConfidenceInterval()/mi.getMean()<=0.05 && mi.numSamples > 50){
        System.out.println(mi.toString());
        
        
        //System.exit(0);
    }
	double nextArrivalTime = clock + tmp;
